...
<head>
	...
	<script src="module/quoInfoMana/js/quoInfoManaTemplet/quoInfoManaTemplet.js"></script>
	<script src="module/quoInfoMana/js/quoInfoMana/Calendar3.js"></script>
	<style type="text/css">
		.tree {
...
<!-- 		</div>  -->
		<div class = "searchArea" >
				时间:从 <input name="birthday" type="text" id="timeBefore" size="10" maxlength="10" onclick="new Calendar().show(this);" readonly="readonly"> 
		</div>
		<div class = "searchArea" >
				到<input name="birthday" type="text" id="timeAfter" size="10" maxlength="10" onclick="new Calendar().show(this);" readonly="readonly"> 
