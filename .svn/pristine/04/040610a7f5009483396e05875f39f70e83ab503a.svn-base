package com.cqut.dao.ProjectUser;
...
public interface ProjectUserDao {
	public int save(ProjectUser projectUser);
	public int saveEntities(@Param("entities")ProjectUser[] projectUsers);
	
	public int updateByID(@Param("entity")ProjectUser projectUser, @Param("id")String ID);
	public int updateByCondition(@Param("entity")ProjectUser projectUser, @Param("condition")String condition);
	...
	public ProjectUser getByID(@Param("ID")String ID);
	public List<ProjectUser> getByCondition(@Param("condition")String condition);
