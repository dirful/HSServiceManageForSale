...
public interface CodeTableDao {
	...
	public int saveEntities(@Param("entities")CodeTable[] codeTables);
	
	public int updateByID(@Param("entity")CodeTable codeTable, @Param("id")String ID);
	public int updateByCondition(@Param("entity")CodeTable codeTable, @Param("condition")String condition);
	...
	public CodeTable getByID(@Param("ID")String ID);
	public List<CodeTable> getByCondition(@Param("condition")String condition);
