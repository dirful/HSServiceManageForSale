...
public interface ProcessDao {
	...
	public int saveEntities(@Param("entities")Process[] processs);
	
	public int updateByID(@Param("entity")Process process, @Param("id")String ID);
	public int updateByCondition(@Param("entity")Process process, @Param("condition")String condition);
	...
	public Process getByID(@Param("ID")String ID);
	public List<Process> getByCondition(@Param("condition")String condition);
