...
public interface PermissionDao {//com.cqut.dao.permission.PermissionDao
	public int save(Permission permission);
	public int saveEntities(@Param("entities")Permission[] permissions);
	
	public int updateByID(@Param("entity")Permission permission, @Param("id")String ID);
	public int updateByCondition(@Param("entity")Permission permission, @Param("condition")String condition);
	...
	public Permission getByID(@Param("ID")String ID);
	public List<Permission> getByCondition(@Param("condition")String condition);
