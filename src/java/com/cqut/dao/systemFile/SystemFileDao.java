...
public interface SystemFileDao {
	...
	public int saveEntities(@Param("entities")SystemFile[] systemFiles);
	
	public int updateByID(@Param("entity")SystemFile systemFile, @Param("id")String ID);
	public int updateByCondition(@Param("entity")SystemFile systemFile, @Param("condition")String condition);
	...
	public SystemFile getByID(@Param("ID")String ID);
	public List<SystemFile> getByCondition(@Param("condition")String condition);
