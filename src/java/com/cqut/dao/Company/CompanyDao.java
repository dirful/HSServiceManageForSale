...
public interface CompanyDao {
	...
	public int saveEntities(@Param("entities")Company[] companys);
	
	public int updateByID(@Param("entity")Company company, @Param("id")String ID);
	public int updateByCondition(@Param("entity")Company company, @Param("condition")String condition);
	...
	public Company getByID(@Param("ID")String ID);
	public List<Company> getByCondition(@Param("condition")String condition);
