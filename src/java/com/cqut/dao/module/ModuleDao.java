...
public interface ModuleDao {
	...
	public int saveEntities(@Param("entities")Module[] modules);
	
	public int updateByID(@Param("entity")Module module, @Param("id")String ID);
	public int updateByCondition(@Param("entity")Module module, @Param("condition")String condition);
	...
	public Module getByID(@Param("ID")String ID);
	public List<Module> getByCondition(@Param("condition")String condition);
