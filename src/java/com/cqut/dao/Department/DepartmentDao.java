...
public interface DepartmentDao {
	...
	public int saveEntities(@Param("entities")Department[] departments);
	
	public int updateByID(@Param("entity")Department department, @Param("id")String ID);
	public int updateByCondition(@Param("entity")Department department, @Param("condition")String condition);
	...
	public Department getByID(@Param("ID")String ID);
	public List<Department> getByCondition(@Param("condition")String condition);
