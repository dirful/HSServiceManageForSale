package com.cqut.dao.ServiceMessage;
...
public interface ServiceMessageDao {
	public int save(ServiceMessage serviceMessage);
	public int saveEntities(@Param("entities")ServiceMessage[] serviceMessages);
	
	public int updateByID(@Param("entity")ServiceMessage serviceMessage, @Param("id")String ID);
	public int updateByCondition(@Param("entity")ServiceMessage serviceMessage, @Param("condition")String condition);
	...
	public ServiceMessage getByID(@Param("ID")String ID);
	public List<ServiceMessage> getByCondition(@Param("condition")String condition);
