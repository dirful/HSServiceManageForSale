...
public interface CheckProcessDao {
	public int save(CheckProcess checkProcess);
	public int saveEntities(@Param("entities")CheckProcess[] checkProcesss);
	
	public int updateByID(@Param("entity")CheckProcess checkProcess, @Param("id")String ID);
	public int updateByCondition(@Param("entity")CheckProcess checkProcess, @Param("condition")String condition);
	...
	public CheckProcess getByID(@Param("ID")String ID);
	public List<CheckProcess> getByCondition(@Param("condition")String condition);
